export default function Lab1() {
    ...
    <div id="wd-lab1">
        ...
        <div id="wd-lists">
            ...
            How to make Steak:
            <ol id="wd-steak">
                <li>Prep the steaks.</li>
                <li>Prepare the rest of the ingredients.</li>
                <li>Season the steaks.</li>
                <li>Heat the pan.</li>
                <li>Cook the steaks.</li>
                <li>Flavor and baste the steaks.</li>
                <li>Rest the steaks.</li>
                <li>Carve the steaks.</li>
            </ol>
        ...
        <div id="wd-forms">
            ...
            <form id="wd-text-fields">
                ...
                <input placeholder="e.g. zChen" id="wd-text-fields-username" /> <br />
        ...
        <input type="radio" name="radio-color" id="wd-radio-orange"/>
        <label htmlFor="wd-radio-orange">Orange</label>
