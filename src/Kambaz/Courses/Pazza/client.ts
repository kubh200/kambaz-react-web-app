...
export const fetchFolders = async (courseId: string) => {
  const response = await axios.get(`${PAZZA_API}/courses/${courseId}/folders`)
  return response.data
}

export const createFolder = async (folder: any) => {
  const response = await axios.post(`${PAZZA_API}/folders`, folder)
  return response.data
}

export const updateFolder = async (folder: any) => {
  const response = await axios.put(`${PAZZA_API}/folders/${folder._id}`, folder)
  return response.data
}

export const deleteFolder = async (folderId: string) => {
  const response = await axios.delete(`${PAZZA_API}/folders/${folderId}`)
  return response.data
}
